    ...
    <div class="col-md-9">
        ...
        <div class="oyuncular-sayfasi">
            ...
            while($gostersahalari = mysql_fetch_array($sahacekelim)){
                ...
                <div class="statlar">
                   <a href="index.php?page=saha-detay&sahalar=<?php echo $gostersahalari['saha_adiseo']; ?>"><div class="statresmi" ><img src="<?php echo $gostersahalari['saha_resim']; ?>" class="img-responsive" style="height:150px;width:100%;"/></div></a>
